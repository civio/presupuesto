...
def set_entity(c, entity, is_secondary_entity=False):
    c['entity'] = entity
    c['is_secondary_entity'] = is_secondary_entity

def is_secondary_entity(c):
    return c.get('is_secondary_entity', False)
