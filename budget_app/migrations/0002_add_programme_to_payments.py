...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.programme'
        db.add_column('payments', 'programme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.programme'
        db.delete_column('payments', 'programme')
    ...
    models = {
        ...
        'budget_app.payment': {
            ...
            'programme': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
