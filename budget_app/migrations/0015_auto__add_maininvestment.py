...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_investments', (
            ...
            ('project_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('entity_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ...
            ('area_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('start_year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('expected_end_year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('actual_end_year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('total_expected_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('already_spent_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('current_year_amount', self.gf('django.db.models.fields.BigIntegerField')()),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('budget_app', ['MainInvestment'])


    def backwards(self, orm):
        # Deleting model 'MainInvestment'
