...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payment.economic_concept'
        db.delete_column('payments', 'economic_concept')


    def backwards(self, orm):
        # Adding field 'Payment.economic_concept'
        db.add_column('payments', 'economic_concept',
