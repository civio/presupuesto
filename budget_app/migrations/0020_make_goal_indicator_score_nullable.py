...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoalIndicator.score'
        db.alter_column('goal_indicators', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GoalIndicator.score'
        raise RuntimeError("Cannot reverse this migration. 'GoalIndicator.score' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'GoalIndicator.score'
        db.alter_column('goal_indicators', 'score', self.gf('django.db.models.fields.FloatField')())
