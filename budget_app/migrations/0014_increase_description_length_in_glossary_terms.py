...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GlossaryTerm.description'
        db.alter_column('glossary_terms', 'description', self.gf('django.db.models.fields.CharField')(max_length=4000))

    def backwards(self, orm):

        # Changing field 'GlossaryTerm.description'
        db.alter_column('glossary_terms', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))
