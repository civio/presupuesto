...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FunctionalCategory.description'
        db.alter_column('functional_categories', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'FunctionalCategory.description'
        db.alter_column('functional_categories', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
