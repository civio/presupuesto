...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MainInvestment.image_URL'
        db.add_column('main_investments', 'image_URL',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MainInvestment.image_URL'
        db.delete_column('main_investments', 'image_URL')
