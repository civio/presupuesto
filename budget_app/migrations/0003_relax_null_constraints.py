...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.area'
        db.alter_column('payments', 'area', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Payment.contract_type'
        db.alter_column('payments', 'contract_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Payment.programme'
        db.alter_column('payments', 'programme', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.area'
        raise RuntimeError("Cannot reverse this migration. 'Payment.area' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Payment.area'
        db.alter_column('payments', 'area', self.gf('django.db.models.fields.CharField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'Payment.contract_type'
        raise RuntimeError("Cannot reverse this migration. 'Payment.contract_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Payment.contract_type'
        db.alter_column('payments', 'contract_type', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Payment.programme'
        db.alter_column('payments', 'programme', self.gf('django.db.models.fields.CharField')(max_length=100))
