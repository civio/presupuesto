    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('budget', models.ForeignKey(to='budget_app.Budget')),
                ('functional_category', models.ForeignKey(to='budget_app.FunctionalCategory', db_column='functional_category_id')),
            ],
            options={
                'db_table': 'goals',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('budget', models.ForeignKey(to='budget_app.Budget')),
                ('functional_category', models.ForeignKey(db_column='functional_category_id', to='budget_app.FunctionalCategory', null=True)),
                ('geographic_category', models.ForeignKey(db_column='geographic_category_id', to='budget_app.GeographicCategory', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('budget', models.ForeignKey(to='budget_app.Budget')),
                ('economic_category', models.ForeignKey(db_column='economic_category_id', to='budget_app.EconomicCategory', null=True)),
                ('functional_category', models.ForeignKey(db_column='functional_category_id', to='budget_app.FunctionalCategory', null=True)),
                ('institutional_category', models.ForeignKey(db_column='institutional_category_id', to='budget_app.InstitutionalCategory', null=True)),
            ],
            options={
                'db_table': 'payments',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('entity', models.ForeignKey(to='budget_app.Entity', db_column='entity_id')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='budget_app.InstitutionalCategory', db_column='institutional_category_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='economic_category',
            field=models.ForeignKey(to='budget_app.EconomicCategory', db_column='economic_category_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='functional_category',
            field=models.ForeignKey(to='budget_app.FunctionalCategory', db_column='functional_category_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='funding_category',
            field=models.ForeignKey(to='budget_app.FundingCategory', db_column='funding_category_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
        ...
        migrations.AddField(
            model_name='budget',
            name='entity',
            field=models.ForeignKey(to='budget_app.Entity', db_column='entity_id'),
            preserve_default=True,
        ),
    ]
