    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('budget', models.ForeignKey(to='budget_app.Budget', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(to='budget_app.Budget', on_delete=models.CASCADE)),
                ('functional_category',
                    models.ForeignKey(to='budget_app.FunctionalCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('goal', models.ForeignKey(to='budget_app.Goal', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(to='budget_app.Budget', on_delete=models.CASCADE)),
                ('functional_category',
                    models.ForeignKey(db_column='functional_category_id',
                        to='budget_app.FunctionalCategory',
                        on_delete=models.CASCADE,
                        null=True)),
                ('geographic_category',
                    models.ForeignKey(db_column='geographic_category_id',
                        to='budget_app.GeographicCategory',
                        on_delete=models.CASCADE,
                        null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(to='budget_app.Budget', on_delete=models.CASCADE)),
                ('economic_category',
                    models.ForeignKey(db_column='economic_category_id',
                        to='budget_app.EconomicCategory',
                        on_delete=models.CASCADE,
                        null=True)),
                ('functional_category',
                    models.ForeignKey(db_column='functional_category_id',
                ...
                ('institutional_category',
                    models.ForeignKey(db_column='institutional_category_id',
                        to='budget_app.InstitutionalCategory',
                        on_delete=models.CASCADE,
                        null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('entity', models.ForeignKey(to='budget_app.Entity', db_column='entity_id', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='budget_app.InstitutionalCategory', db_column='institutional_category_id', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='economic_category',
            field=models.ForeignKey(to='budget_app.EconomicCategory', db_column='economic_category_id', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='functional_category',
            field=models.ForeignKey(to='budget_app.FunctionalCategory', db_column='functional_category_id', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
            name='funding_category',
            field=models.ForeignKey(to='budget_app.FundingCategory', db_column='funding_category_id', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='budgetitem',
        ...
        migrations.AddField(
            model_name='budget',
            name='entity',
            field=models.ForeignKey(to='budget_app.Entity', db_column='entity_id', on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
