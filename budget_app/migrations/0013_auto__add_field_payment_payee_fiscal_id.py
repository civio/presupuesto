...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.payee_fiscal_id'
        db.add_column('payments', 'payee_fiscal_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.payee_fiscal_id'
        db.delete_column('payments', 'payee_fiscal_id')
