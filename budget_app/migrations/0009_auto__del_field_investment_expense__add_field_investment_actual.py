...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Investment.expense'
        db.delete_column('investments', 'expense')

        # Adding field 'Investment.actual'
        db.add_column('investments', 'actual',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Investment.expense'
        db.add_column('investments', 'expense',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Investment.actual'
        db.delete_column('investments', 'actual')
