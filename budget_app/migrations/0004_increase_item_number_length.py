...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('budget_items', 'item_number', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'BudgetItem.item_number'
        db.alter_column('budget_items', 'item_number', self.gf('django.db.models.fields.CharField')(max_length=3))
