...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FunctionalCategory.subprogramme'
        db.add_column('functional_categories', 'subprogramme',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FunctionalCategory.subprogramme'
        db.delete_column('functional_categories', 'subprogramme')
    ...
    models = {
        ...
        'budget_app.functionalcategory': {
            ...
            'subprogramme': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
