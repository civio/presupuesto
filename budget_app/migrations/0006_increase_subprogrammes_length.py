...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'BudgetItem.item_number'
        db.alter_column('functional_categories', 'subprogramme', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))


    def backwards(self, orm):
        # Changing field 'BudgetItem.item_number'
        db.alter_column('functional_categories', 'subprogramme', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
